define(
    ...
    function (state, log) {
        ...
        function getBestVoice() {
            ...
            // because this is what we like on Chrome for OS X.

            // In the future, the intention is to compute the best voice based
            // on what is available in the current browser and maybe the
            // current document language, etc.
        ...
        function speak(text, voice, polite, force) {
            ...
            text = text.replace(/sitecues/i, 'sightcues');
        ...
        function init() {
            ...
            addEventListener('unload', events.onUnload, true);
