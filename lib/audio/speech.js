define(
    ...
    function (state, Promise, log) {
        ...
        function getVoices() {
            ...
            // If the current browser gets voices synchronously, return those.
            // (Safari)
            ...
            // have any voices available. No such situation has been
            // encountered, so this code assumes that voices will be found
            // sooner or later.

            function checkVoices(resolve, reject) {
                ...
                if (voices.length) {
                    ...
                    setTimeout(checkVoices, 4000, resolve, reject);
                }
            }

            return new Promise(checkVoices);
        }
        ...
        function init() {
            ...
            // Return a promise for voices. Makes init asynchronous!
            return getVoices().then(cacheVoices);
        }
