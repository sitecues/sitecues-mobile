define(
    ...
    function () {
        ...
        var // Internal, canonical representation of application-wide state.
            _state = {
                initialized : false,
                speechOn    : false,
                online      : true
            ...
            state = {
                // TODO: Consider using signals instead of events.
                // See: https://github.com/sholladay/adverb-signals
            };
        ...
        Object.defineProperties(state, {
            ...
            voices : {
                enumerable : true,
                writable   : true,  // will be written to on 'voiceschanged' event
                value      : []
            },
