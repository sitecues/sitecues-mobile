        ...
        const createBadge = () => {
            ...
            const show = (delay) => {
                ...
                return new Promise((resolve) => {
                    setTimeout(
                        unhideBadge,
                        delay || 0,    // wait time before starting to animate
                        resolve
                    );
                });
            };
        ...
        const createBadgeImage = () => {
            ...
            const load = () => {
                ...
                return new Promise((resolve, reject) => {
                    ...
                    const badgeImageUrl = '//googledrive.com/host/0B18rz_WzoeJQeUZfVW9uOVoxT0U/sitecues-icon-extra-padded-x500.png';
                    elem.src = state.protocol + badgeImageUrl;
                });
            };
