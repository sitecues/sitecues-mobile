define(
    ...
    function (state, Promise, speech, log) {
        ...
        function createBadge() {
            ...
            function show(delay) {
                ...
                return new Promise(function (resolve, reject) {
                    setTimeout(
                        unhideBadge,
                        delay,    // how long to wait before showing the element
                        resolve,
                        reject
                    );
                });
        ...
        return {
            // For now, init is just an alias to show. But in the future, we
            // may not want to show the UI right away when we initialize.
            // By having other modules use the appropriate semantic API,
            // we make this process less crazy in the future.
            init : init
        };
    }
);
